...
使用设备摄像头拍摄一张照片并保存到当前 workspace。返回可传给其他本地工具的相对路径、文件大小和分辨率。
...
只有 save_to_photos=true 时才会请求相册权限并保存到系统相册。
"""
    ...
    public func execute(
        ...
        // 6. 启动会话。execute 不受 MainActor 隔离，避免阻塞 UI 线程。
